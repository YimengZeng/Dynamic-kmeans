...
% /home/fmri/fmrihome/SPM/spm8_scripts/FunctionalConnectivity/fconnect_config_wm_cfs_nogs_final.m.template
%
...
for FCi = 1:sublength
  ...
  for roicnt = 1:numroi                              
    ...
    %-STEP 6 --------------------------------------------------------------
    disp('Running FC .....................................................');
    stats_fmri_fconnect_noscaling(temp_dir, data_type, NUMTRUNC, newimagefilter, TR_val);
    cd(run_FC_dir) 
  end
